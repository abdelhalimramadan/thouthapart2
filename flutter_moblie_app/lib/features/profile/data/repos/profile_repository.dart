...
class ProfileRepository {
  ...
  Future<ProfileModel> fetchProfile() async {
    ...
    try {
      ...
      if (profileResult['success'] == true &&
          profileResult['data'] is ProfileModel) {
        final profile = profileResult['data'] as ProfileModel;
        print(
  ...
  Future<ProfileModel?> _getProfileFromToken() async {
    try {
      final token =
  ...
  Future<void> _cacheProfileLocally(ProfileModel profile) async {
